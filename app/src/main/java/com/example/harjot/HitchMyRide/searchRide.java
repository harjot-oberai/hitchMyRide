...
public class searchRide extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_have_aride);
        setUpAnimation();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.have_aride, menu);
        return true;
    }
    ...
    private List<RideDetails> createList() {
        List<RideDetails> result;
        result=data_base.getAllContacts();
        return result;
    }
